...
export interface IslandBossConfig {
  ...
  descKey: string;
  emoji: string;
  /** Unique boss identifier used for portProgress lookup. */
  bossId: string;
  /** Navigation route for the boss encounter page. */
  bossRoute: string;
}
...
registerIsland({
  ...
  bossConfig: {
    ...
    emoji: '\u2744\uFE0F',
    bossId: 'boss-precision-gauntlet',
